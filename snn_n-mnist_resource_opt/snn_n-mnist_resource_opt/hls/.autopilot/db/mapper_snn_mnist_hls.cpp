...
using hls::sim::Byte;
extern "C" void snn_mnist_hls(short*, Byte<1>*);
extern "C" void apatb_snn_mnist_hls_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  snn_mnist_hls(sinput_r->data<short>(), __xlx_output_r__tmp_vec.data());
