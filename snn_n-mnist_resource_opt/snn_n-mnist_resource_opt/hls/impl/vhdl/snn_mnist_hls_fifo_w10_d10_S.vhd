...
entity snn_mnist_hls_fifo_w10_d10_S is 
    generic (
...
architecture rtl of snn_mnist_hls_fifo_w10_d10_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component snn_mnist_hls_fifo_w10_d10_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 10;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 10);
...
begin
----------------------- Instantiation -----------------------
    U_snn_mnist_hls_fifo_w10_d10_S_ShiftReg : snn_mnist_hls_fifo_w10_d10_S_ShiftReg
    generic map (
...
entity snn_mnist_hls_fifo_w10_d10_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 10;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 10);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end snn_mnist_hls_fifo_w10_d10_S_ShiftReg;

architecture rtl of snn_mnist_hls_fifo_w10_d10_S_ShiftReg is
